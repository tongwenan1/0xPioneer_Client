...
export class Ethereum extends EventEmitter {
            ...
            case WalletType.bitkeep:
                {
                    ...
                    this._provider = win.ethers.BrowserProvider(win.bitkeep && win.bitkeep.ethereum);
                }
                break;
            ...
            case WalletType.bitizen:
                {
                    ...
                    this._provider = win.ethers.BrowserProvider(win.ethereum);
                }
                break;
            default:
                {
    ...
    public getContract(name: contractNames, addr: string = ""): ethers.Contract {
        ...
        if (!this._contracts[key]) {
            ...
            this._contracts[key] = win.ethers.Contract(addr ? addr : abi.addr, abi.abi, this._signer);
        }
    ...
    public async getDecimalsErc20ByAddr(contract_addr: string): Promise<number> {
        ...
        let contract = win.ethers.Contract(contract_addr, abi);
